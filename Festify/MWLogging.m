...
{ \
	...
	asl_log(NULL, NULL, (LEVEL), "%s", [[NSString stringWithFormat:@"%@ %@", \
        [[[[NSThread callStackSymbols] objectAtIndex:1] componentsSeparatedByCharactersInSet:[NSCharacterSet characterSetWithCharactersInString:@"[]"]] objectAtIndex:1], message] UTF8String]); \
	va_end(args); \
}
